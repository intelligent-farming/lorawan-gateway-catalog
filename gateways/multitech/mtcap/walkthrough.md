# Connect the MultiTech Conduit AP (MTCAP) to ChirpStack

The **MultiTech Conduit AP (MTCAP)** (SX1308) forwards LoRaWAN uplinks to a ChirpStack
...
> Indoor LoRaWAN access point (packet-forwarder only, no built-in NS). MTCAP/MTCAP2 = SX1308; MTCAP3 (Conduit AP 300) = SX1302 (use the SX1302 radio block). mPower JSON editor — paste the config. Basics Station needs mPower >= 5.3.

---
_Catalog profile: `multitech/mtcap`._
