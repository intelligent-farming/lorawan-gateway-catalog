# Connect the RAK7268V2 WisGate Edge Lite 2 to ChirpStack

The **RAK7268V2 WisGate Edge Lite 2** (SX1302) forwards LoRaWAN uplinks to a ChirpStack
Gateway Bridge. This walkthrough gets it online using the connection settings
and config Leftenant generated above.

## 1. Reach the gateway

- Open **http://192.168.230.1** (AP-mode Wi-Fi SSID `RAK7268V2_XXXX`).
...
> Current SKU replacing the EOL RAK7268 (WisGateOS 1). WisGateOS 2, SX1302. RAK7268V2 (no LTE), RAK7268CV2 (LTE, AP SSID RAK7268CV2_XXXX), and RAK7268CV2-V (Verizon, SX1303) share this config skeleton.

---
_Catalog profile: `rakwireless/rak7268v2`._
